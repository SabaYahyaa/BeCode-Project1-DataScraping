...
class HouseApartmentScraping:
    ...
    def __init__(self, url):
        ...
        # set of attributes collected in the house_dict dictionary
    ...
    # Define a method to scrape each property attribute
    ...
    # store all attibutes of each property to a csv file.  
    def add_csv (self):
         with open('csv_files/houses_apartments_urls.csv', 'aw') as file:
